...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      ...
      int v2 = 28;
      int v3 = 41;
      System.out.println("calculatBMI = "+ MyUtil.calculateBMI(weight, height));
      System.out.println("average = "+MyUtil.average(v1, v2, v3));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      Person person1 = new Person(11001);
      Person person2 = new Person(11002);
